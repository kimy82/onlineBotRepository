...
ALTER TABLE PROMOCIONS ADD COLUMN ACTIU_DIMARTS tinyint(1) NOT NULL DEFAULT 1;
ALTER TABLE PROMOCIONS ADD COLUMN ACTIU_DIMECRES tinyint(1) NOT NULL DEFAULT 1;
ALTER TABLE PROMOCIONS ADD COLUMN ACTIU_DIJOUS tinyint(1) NOT NULL DEFAULT 1;
ALTER TABLE PROMOCIONS ADD COLUMN ACTIU_DIVENDRES tinyint(1) NOT NULL DEFAULT 1;
ALTER TABLE PROMOCIONS ADD COLUMN ACTIU_DISSABTE tinyint(1) NOT NULL DEFAULT 1;
