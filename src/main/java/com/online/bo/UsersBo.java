...
public interface UsersBo {
	...
	void sendEmail(String txt, String email,String app,String subject) throws BOException; 
	
	void sendEmails(String txt, String[] emails,String app) throws BOException;
