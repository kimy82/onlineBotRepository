							...
							if (json.alerta != null) {
								...
								var plats= json.platsNames;	       					
		       					...
		       					$.each(plats, function(index, value) { 		 
		       							...
		       							var li= value.numPlats+" <span class='plats' id='span_p_"+value.idPlat+"'>x</span> "+value.nomPlat+"&nbsp;<a href='#' onclick='eliminaPlat("+value.idPlat+")' ><img src='/"+context+"/images/delete.png'></a><br><br>";
		       							 lis=lis+li;		       					
