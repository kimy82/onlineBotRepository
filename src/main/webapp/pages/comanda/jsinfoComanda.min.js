...
$(function(){var availableStreets=["Abat escarre","Abeuradors","Acacia","Adri, d'","Agudes","Agullana","Agusti riera i pau","Aiguaviva, d'","Alacant","Albacete","Albera , l'","Albereda","Albi","Alemanys","Alfred nobel","Almogavers","Alps","Alvarez de castro","Alvarez de castro,carrero","Amical mauthaussen,avinguda","Andalusia","Andalusia,plaça","Andreu tuyet i santamaria","Aneto","Aneto,plaça","Angel","Angel marsa i beca","Angel seradell i perez","Angel serradell i perez","Angela bivern","Anselm clave","Anso llucia","Antiga d'amer,carretera","Antoni canet","Antoni gaudi i cornet,carrer","Antoni rovira i virgili","Antoni vares i martinell","Antonia adroher i pascual","Arago","Arc","Argenteria","Artillers","Assemblea de catalunya,plaça","Assumpcio,plaça","Asturies","Atlantida","Auriga, n'","Auriga,travessia","Aurora bertrana salazar","Aurora, l',plaça","Avel.li artis i gener,carrer","Avellaneda, l' (sector)","Avellaner","Avi xaxu","Bailen","Baix","Balandrau","Balandrau,passatge","Baldiri reixach","Balears","Ballesteries","Baluard","Banyoles","Barca","Barcelona","Barranc","Barrufa,pujada","Basagoda","Bascanella","Bastiments","Beates","Bell-lloc,plaça","Bellaire","Bellavista","Bellmirall","Bellpuig","Berenguer carnicer","Bernat bacia","Bernat boades","Bertrana prudenci,plaça","Bescano","Bilbao","Blas fournas","Bluefields","Bonastruc de porta","Bonaventura carreras i peralta","Bosquet","Bou d'or,riera","Bru barnoya i xiberta","Bruc","Buganto,riera","Bullidors","Cabrera,illa","Cadi","Calderers","Camil geis i parragueras","Camp d'or","Camp de la bateria","Camp de la creu","Camp de la plana","Camp de les lloses","Camp de mart","Camp gurnau","Campcardos","Campcardos,passatge","Can llobet","Can massa","Can pau birol","Can prunell","Can sopa","Can sunyer","Can sureda","Can sureda,passatge","Can torroella","Can triola","Canaders,travessia","Canalejas,passeig","Canet d'adri","Canigo","Cantabric","Cap de creus","Caputxins","Caputxins, muntanya","Caputxins,disseminat","Cardenal margarit","Carles rahola","Carles riba i bracons","Carme","Carme auguet","Carril,travessia","Cartagena","Cartella","Castanyer","Castanyes,plaça","Castell de bellaguarda","Castell de cartella","Castell de montgri","Castell de montsolis","Castell de perelada","Castell de requesens","Castell de solterra","Castell, pujada","Castellet","Castello de la plana","Catalunya,plaça","Catalunya,rambla","Catedral,plaça","Catedral,pujada","Caterina albert","Cavallers","Central","Cerveri de girona","Cervino","Ciutadans","Ciutat de figueres, de la,plaça","Ciutat de figueres,plaça","Claveria","Coll d'ares","Collsacabra","Coma","Comanegre","ComerÇ","Conflent,carrero","Constitucio,plaça","Cor de maria","Correu vell,plaça","Corsega","Cort-reial","Corunya, la","Costa brava","Costabona","Costal, cassia","Creu","Creu de palau,disseminat","Creu de palau,pujada","Creu,travessia","Creus, les","Cristofol colom","Cristofol grober","Croada","Damia estela i molinet","Daro, riu","Devesa,passeig","Diputacio,plaça","Doctor carles rev. bolos","Domenech fita i molat,plaça","Domeny","Domeny,disseminat","Eivissa","Eiximenis","Elx","Emili blanch i roig","Emili grahit","Emilia xargay i pages,carrer","Emporda","Empuries","Enderrocades","Enric adroher i pascual","Enric claudi girbal i nadal","Enric claudi girbal i nadal,plaça","Enric marques i ribalta","Enric prat de la riba","Escola de montjuich, de l',cami","Escola pia","Escorial, el","Esglesia de sant miquel","Espanya,plaça","Esperanto","Esport","Estudi general de girona, l'","Europa,plaça","Everest","Fabrica,travessera","Falgas","Far","Far,passatge","Farigola,passatge","Federica montseny maÑe","Federico fellini,plaça","Federico garcia lorca","Ferradura","Ferran agullo","Ferran el catolic","Ferran puig,ronda","Ferran soldevila i zubiburu","Ferrandiz i belles","Ferreries velles","Fidel aguilar i marco,plaça","Figuerola","Finistrelles","Fluvia, riu","Font","Font abella","Font de l'abat,cami","Font de la lluna","Font de la polvora,avinguda","Font del bisbe,baixada","Font del cano,baixada","Font del rei","Fontanilles","Fontanilles","Fontejou","Forca","Formentera,illa","Fornells, vell de,cami","Fort roig,ronda","Fossats, dels,passatge","Fra ignasi barnova i oms,plaça","França,avinguda","Francesc artau","Francesc calvet i rubalcaba,plaça","Francesc ciurana","Francesc civil","Francesc coll","Francesc coll i turbau","Francesc estival cisa","Francesc macia","Francesc mateu","Francesc palau i quer","Francesc pi i margall,passatge","Francesc roges","Francesc romaguera","Francesc samso","Francesc xavier dorca","Fructuos gelabert badiella","Fuerteventura,illa","Galicia","Galligans","Garrap,riera","Garrotxa,plaça","Gaspar casal","Gavarres","General marva","General marva,plaça","General mendoza,passeig","General o'donnell","General peralta","George stephenson","Georges melies","Germans lumiere","Germans sabat,grup","Germans sabat,plaça","Gerundense, la","Gillem collteller","Ginesta","Ginestar","Girona per girona,grup","Girona,plaça","Glacis, dels,passatge","Gomera, illa","Gomez miquel,passatge","Gran canaria,illa","Guadiana","Guillem bofill","Guilleries","Guipuscoa","Heroines de santa barbara","Himalaia","Hispanitat,avinguda","Hortensia","Hortes","Hortes,disseminat","Hospital,plaça","Hostal nou","Iberia","Ignasi iglesias","Ill","Illes filipines","Illes formigues","Illes medes","Impressors bro","Impressors oliva","Independencia,plaça","Industria, de la","Institut vell,porta","Isabel la catolica","Isabel vila i pujol,plaça","Jacint verdaguer i santalo,plaça","Jardins de l'arquitecte ignasi bosch i reitg","Jardins de la riera gornau","Jardins germans maristes","Jardins john lennon","Jardins pedreres","Jaume balmes","Jaume i, gran via","Jaume ministral","Jaume pons i marti","Jaume roca i delpech","Jaume vicens i vives","Jeroni real de fontclara","Joan alsina","Joan badia i casanyas","Joan baptista torroella i bastons","Joan bruguera","Joan coromines i vigneaux","Joan gaspar roig i gelpi","Joan josep tharrats vidal","Joan maragall","Joan maria pou i camps","Joan maso i valenti","Joan masso i valenti","Joan miro i ferra","Joan oliver i sallares 'pere quart'","Joan planas i castaÑer","Joan pons","Joan regla","Joan roca i pinet","Joan salvat i papaseit","Joan torro i cabratosa","Joan viÑas i bona,carrer","Joana jugan, de,porta","Joaqui maria masramon ventos","Joaquim botet i siso","Joaquim camps i arboix,plaça","Joaquim maria masramon i de ventos","Joaquim riera i bertran","Joaquim riera i bertran,carrer","Joaquim ruyra i homs","Joaquim vayreda","Jocs olimpics de barcelona","Joeria petita","Jose canalejas,passatge","Josep aguilera i marti","Josep ametller i viñas","Josep ametller i viñas,plaça","Josep baro i gÜell,passatge","Josep bosch i puy","Josep canal i roquet,carrer","Josep carner i puig-oriol,passeig","Josep cartaña","Josep clara","Josep dalmau i carles","Josep ferrater i mora,plaça","Josep gironella i pous","Josep irla i bosch,plaça","Josep maluquer salvador","Josep maria corredor i pomes","Josep maria corredor i pomes,travessia","Josep maria dalmau i casadement","Josep maria pages i vicens","Josep maria pages i vicens,carrer","Josep maria pons i guri,carrer","Josep maria prat","Josep morato i grau","Josep morera","Josep narcis roca i farreras","Josep pallach i carola,plaça","Josep pascual i prats","Josep pla i casadevall,plaça","Josep tarradellas i joan,avinguda","Josep tharrats","Josep trueta i raspall","Josep viader i moliner","Josep vicens foix i mas","Juli garreta","Julia de chia","Julian bolivar, de","Jurats,plaça","Just manuel casero i madrid, de","Laurea dalmau i pla","Lepant","Llebre","Lledoners,plaça","Lleida","Lleons,disseminat","Llibertat,rambla","Llierca","Llimoner,plaça","Llora","Lluis antoni santalo i parvorell","Lluis batlle i prats","Lluis borrassa","Lluis company","Lluis pericot,avinguda","Lola anglada","Lope de vega","Madrid,plaça","Mallorca","Manaies","Manel bonmati i remaguera,passatge","Manel carrasco i formiguera","Manel quer","Manel viñas i grauges","Manuel cazurro ruiz","Manuel cundaro","Mare de deu de fatima","Mare de deu de la salut","Mare de deu de montserrat,plaça","Mare de deu de nuria","Mare de deu de rocacorba","Mare de deu del collell","Mare de deu del loreto","Mare de deu del mont","Mare de deu del pilar","Mare de deu del remei","Mare de deu dels angels","Marfa","Maria angels anglada abadal","Maria angels anglada i d'abadal","Maria aurelia capmany i farnes","Maria aurelia capmany i farnes,passatge","Maria auxiliadora,plaça","Maria gay i tibau,passatge","Maria josepa arnall i juan,carrer","Marques de caldes de montbui","Marques de camps,plaça","Marques i casanovas jaume","Marroc,riera","Marti i, l'huma","Marti sureda i deulovol","Mas abella","Mas abella,urbanitzacio","Mas amat","Mas aragai","Mas barril","Mas carreras","Mas catofa","Mas devesa","Mas figueres","Mas grau","Mas jardi","Mas ramada","Mas vendrell","Mas verd","Massaguer, dels,passatge","Massana ","Massolet","Medieval","Mela mutermilch, de,plaça","Menorca","Mercaders","Merce roderada i guirigui","Merce,pujada","Merlets","Migdia","Migdia,passatge","Miguel hernandez","Mimosa","Minali","Miquel blay","Miquel coll i alentorn","Miquel de palol,plaça","Miquel oliva i prat","Miquel santalo i pavorell,plaça","Miquel santalo i sors","Mirador de agusti pera i planells","Modaguera gran","Monar","Monges, les","Monges,disseminat","Montbo","Montcalm","Montfalgas","Montilivi,avinguda","Montilivi,disseminat","Montjovi","Montjuic","Montjuic, muntanya","Montnegre","Montori","Montorro","Montseny","Montserrat roig i transitora","Mora","Mosques","Mossen ferran forns i navarro","Mossen josep iglesias i juanmiquel,plaça","Muga","Muntany","Muntanya can simon, de la,passatge","Muralla","Narcis blanch","Narcis figueres i reixach,plaça","Narcis monturiol","Narcis xifra i masmitja","Neu","Noguer","Nord","Nostra senyora carme gubert","Nou","Nou del teatre","Obra","Oli,plaça","Olivera","Olles","Olot,passeig","Om,plaça","Onofre pou, n',escalas","Onze de setembre","Orient","Oriol martorell i codina","Osca","Oviedo","Pablo ruiz picasso,plaça","Paisos catalans,plaça","Palafrugell","Palagret,riera","Palamos","Palau sacosta","Palau sacosta,disseminat","Palau,plaça","Palco dels sastres","Pallol, del,plaça","Palma, illa de la","Palol berenguer","Palol d'onyar","Pamplona","Pascual i carbo, peius","Pau casals","Pau miranda","Pau vila i dinares,carrer","Pedraforca","Pedreres,pujada","Pedret","Pedret,ronda","Peixeteries velles","Pep colomer i marti","Pere calders i rossinyol,plaça","Pere comte","Pere costa i cases","Pere de palol","Pere iii el ceremonios","Pere matas","Pere palol i salellas","Pere rabat,passatge","Pere rocaberti","Pere sacoma, de,placeta","Perill","Pic de la dona","Pic de peguera","Pica d'estats","Picapedrers,passatge","Pierre vilar","Pineda","Pirineu","Pla guillem","Pla i cargol","Pla,disseminat","Planura","Poeta eduard marquina,plaça","Polvorins,pujada","Pompeu fabra,plaça","Pont de la barca","Pont de pedra,pujada","Pont major","Pont major,disseminat","Pont major,grup","Port lligat","Portal de frança","Portal de la barca","Portal nou","Portal nou,travessia","Porvenir","Pou de la torre","Pou rodo","Premsa","Primer de maig,pujada","Princep","Progres, del","Progres, del,passatge","Pruner","Puig aulet, del,passatge","Puig d'adri","Puig d'aguiles","Puig d'en roca","Puig de montilivi","Puig estela, del,passatge","Puigmal","Puigneulos","Puigneulos,passatge","Puigpedros","Puigsacalm","Puigvistos,plaça","Puigvistos,urbanitzacio","Pujada als caputxins","Punta del pi","Rafael alberti,plaça","Rafael casanova i comes,plaça","Rafael maso i valenti","Raims,plaça","Rajolers","Rambla tet montoliu i massana","Ramon berenguer ii 'cap d'estopes',passeig","Ramon berenguer ii,passeig","Ramon folch,avinguda","Ramon llull","Ramon muntaner","Ramon turro","Reggio emilia","Regiment de baza","Reina joana, de la,passeig","Remences","Ricard giralt i casadesus","Ricard giralt i casadesus,passatge","Ricard guino i boix","Ridaura","Riera can punxa, de la,passatge","Riera d'oix","Riera d'osor","Riera de can camaret","Riera de llemana","Riera de mus","Rierol","Rimau","Rissec, paratge","Riu brugent","Riu cardener","Riu freser","Riu güell","Riu güell,plaça","Riu onyar","Riu segre","Riu ser","Riu ter","Riu terri","Riu tordera","Roc de frausa","Roca colom","Roca, antic","Rodona,plaça","Roma","Romani,passatge","Romanya","Roques altes","Ros de palau","Rosa","Rosello","Roses, voltes d'en,plaça","Roure","Rovira canonge","Rutll","Sac, del","Sacsimort","Salt,plaça","Salvador dabau i caussa","Salvador dali i domenech,plaça","Salvador espriu,plaça","Salvador ferrer c. maura","Sant agusti","Sant aniol","Sant antoni maria claret,ronda","Sant cristofol","Sant daniel","Sant domenec,plaça","Sant domenec,pujada","Sant feliu de guixols,carretera","Sant feliu,plaça","Sant feliu,pujada","Sant francesc,avinguda","Sant grau","Sant gregori,carretera","Sant hipolit","Sant ignasi","Sant isidre","Sant joan bautista de la salle","Sant joan bosco,passeig","Sant jordi","Sant jordi,plaça","Sant josep","Sant josep,plaça","Sant llorenç","Sant marti,pujada","Sant medir","Sant miquel","Sant miquel,disseminat","Sant narcis,avinguda","Sant pau","Sant pere,plaça","Sant ponç,disseminat","Sant ponç,plaça","Sant roc","Sant salvador d'horta","Sant sebastia","Santa clara","Santa coloma, de la carretera,disseminat","Santa coloma,carretera","Santa eugenia","Santa eugenia,disseminat","Santa eugenia,passeig","Santa eugenia,plaça","Santa eugenia,travessia","Santa eugenia,travessia","Santa llucia","Santa maria","Santa susana,plaça","Santander","Santiago","Santiago coquard i sala,carrer","Santiago rusiñol","Santiago sobreques","Saragossa","Sardenya","Sarria de ter","Sarriera","Segle xvi","Segovia","Sequia","Serra alta","Serra de bestraca","Serra de finestres","Serra de vall-lloreda","Serres","Sevilla","Sibil la de fortia","Sicilia, illa","Silvestre santalo","Sol","Susqueda","Taga","Taial","Taial","Talarn","Taquigrafo fc. de paula marti i mora","Tarragona","Tarrus i bru joan","Teide","Tenerife,illa","Terç de miquelets","Terol","Tete montoliu massana,rambla","Tomas baraut,plaça","Tomas carreras i artau","Tomas lorenzana","Tomas mieres","Tomas roig i llop","Tomas sivilla","Torin","Torrassa,pujada","Torre alfons xii,pujada","Torre de sant lluis","Torre de sant narcis","Torre de taiala","Torre de taiala,plaça","Torre de taiala,urbanitzacio","Torre del cerda","Torre dels socors","Torre gironella","Torre gironella,grup","Torre malla","Torre rafaela,urbanitzacio","Torre san joan","Torre sant daniel","Torre suchet","Torrent","Torrent gornau,passatge","Torres de palau","Tosa d'alp","Tramont","Trasfigueres","Trens petits","Tres alzines,plaça","Tres reis","Tretzevents","Troia","Turo","Turo de can ponç","Turo de morou","Turo rodo","Ullastret","Ultonia","Univers","Universitat de cervera","Universitat de girona","Universitat de montpeller","Valencia","Valenti almirall i llozer","Valenti fargnoli","Vall umbrosa, de la,passatge","Valladolid","Ver","Vessador","Vesubi","Vi, del,plaza","Vic,plaça","Vicenç bou","Vila de perpinya, de la,plaça","Vila-roja,disseminat","Vila-roja,grup","Vint de juny de 1808,avinguda","Vista alegre","Vitoria gasteiz","Vuit de juliol de 1809","Xavier cugat,rambla","Xavier montsalvatge","Zamora","Zaragoza"];$("#carrer").autocomplete({source:availableStreets});$("#carrerbis").autocomplete({source:availableStreets});});
$(function(){var availableCodis=["17007","17005","17006","17004","17003","17002","17001",];$("#codi").autocomplete({source:availableCodis});$("#codibis").autocomplete({source:availableCodis});});
window.google=window.google||{};google.maps=google.maps||{};(function(){function getScript(src){document.write("<"+'script src="'+src+'"'+' type="text/javascript"><'+"/script>");}var modules=google.maps.modules={};google.maps.__gjsload__=function(name,text){modules[name]=text;};google.maps.Load=function(apiLoad){delete google.maps.Load;apiLoad([0.009999999776482582,[[["http://mt0.googleapis.com/vt?lyrs=m@210000000\u0026src=api\u0026hl=en-US\u0026","http://mt1.googleapis.com/vt?lyrs=m@210000000\u0026src=api\u0026hl=en-US\u0026"],null,null,null,null,"m@210000000"],[["http://khm0.googleapis.com/kh?v=125\u0026hl=en-US\u0026","http://khm1.googleapis.com/kh?v=125\u0026hl=en-US\u0026"],null,null,null,1,"125"],[["http://mt0.googleapis.com/vt?lyrs=h@210000000\u0026src=api\u0026hl=en-US\u0026","http://mt1.googleapis.com/vt?lyrs=h@210000000\u0026src=api\u0026hl=en-US\u0026"],null,null,"imgtp=png32\u0026",null,"h@210000000"],[["http://mt0.googleapis.com/vt?lyrs=t@130,r@210000000\u0026src=api\u0026hl=en-US\u0026","http://mt1.googleapis.com/vt?lyrs=t@130,r@210000000\u0026src=api\u0026hl=en-US\u0026"],null,null,null,null,"t@130,r@210000000"],null,null,[["http://cbk0.googleapis.com/cbk?","http://cbk1.googleapis.com/cbk?"]],[["http://khm0.googleapis.com/kh?v=72\u0026hl=en-US\u0026","http://khm1.googleapis.com/kh?v=72\u0026hl=en-US\u0026"],null,null,null,null,"72"],[["http://mt0.googleapis.com/mapslt?hl=en-US\u0026","http://mt1.googleapis.com/mapslt?hl=en-US\u0026"]],[["http://mt0.googleapis.com/mapslt/ft?hl=en-US\u0026","http://mt1.googleapis.com/mapslt/ft?hl=en-US\u0026"]],[["http://mt0.googleapis.com/vt?hl=en-US\u0026","http://mt1.googleapis.com/vt?hl=en-US\u0026"]],[["http://mt0.googleapis.com/mapslt/loom?hl=en-US\u0026","http://mt1.googleapis.com/mapslt/loom?hl=en-US\u0026"]],[["https://mts0.googleapis.com/mapslt?hl=en-US\u0026","https://mts1.googleapis.com/mapslt?hl=en-US\u0026"]],[["https://mts0.googleapis.com/mapslt/ft?hl=en-US\u0026","https://mts1.googleapis.com/mapslt/ft?hl=en-US\u0026"]]],["en-US","US",null,0,null,null,"http://maps.gstatic.com/mapfiles/","http://csi.gstatic.com","https://maps.googleapis.com","http://maps.googleapis.com"],["http://maps.gstatic.com/intl/en_us/mapfiles/api-3/12/5","3.12.5"],[1350400096],1,null,null,null,null,0,"",null,null,0,"http://khm.googleapis.com/mz?v=125\u0026",null,"https://earthbuilder.googleapis.com","https://earthbuilder.googleapis.com",null,"http://mt.googleapis.com/vt/icon"],loadScriptTime);};var loadScriptTime=(new Date).getTime();getScript("http://maps.gstatic.com/intl/en_us/mapfiles/api-3/12/5/main.js");})();
function Map(elementId,geolocation){var myOptions={zoom:13,mapTypeId:google.maps.MapTypeId.ROADMAP};var map=new google.maps.Map(document.getElementById(elementId),myOptions);var marker=new google.maps.Marker({position:geolocation,title:"Here is your address!"});map.setCenter(geolocation);marker.setMap(map);}var Address={addressValidation:function(addressOK,addressKO){var self=this;self._init(addressOK,addressKO);var button=document.getElementById("checkAdd");button.onclick=self.checkAdd;}};Address.addressValidation.prototype._carrer=null;Address.addressValidation.prototype._numcarrer=null;Address.addressValidation.prototype._codi=null;Address.addressValidation.prototype._poble=null;Address.addressValidation.prototype._mapdiv=null;Address.addressValidation.prototype._button=null;Address.addressValidation.prototype._infoLabel=null;Address.addressValidation.prototype._addressOK=null;Address.addressValidation.prototype._addressKO=null;Address.addressValidation.prototype._init=function(addressOK,addressKO){this._carrer=document.getElementById("carrer");this._numcarrer=document.getElementById("numcarrer");this._codi=document.getElementById("codi");this._poble=document.getElementById("poble");this._mapdiv=$("#map_canvas");this._infoLabel=$("#addressOK");Address.addressValidation.prototype._addressOK=addressOK;Address.addressValidation.prototype._addressKO=addressKO;};Address.addressValidation.prototype.checkAdd=function(){var address=$("#carrer").val()+","+$("#codi").val()+", Girona, Spain";var codiPostal=$("#codi").val();if(codiPostal!="17001"&&codiPostal!="17002"&&codiPostal!="17003"&&codiPostal!="17004"&&codiPostal!="17005"&&codiPostal!="17006"&&codiPostal!="17007"){$("#addressOK").text(Address.addressValidation.prototype._addressKO);return false;}var addressToSave=$("#carrer").val()+"-"+codiPostal;if($("#carrer").val()==""||codiPostal==""){$("#addressOK").text(Address.addressValidation.prototype._addressKO);return false;}address=address.replace(/\n/g,"");var geocoder=new google.maps.Geocoder();geocoder.geocode({"address":address},function(results,status){if(status==google.maps.GeocoderStatus.OK){var addressGoogle=results[0].formatted_address;numCommas=addressGoogle.match(/,/g).length;if(numCommas>=2){addressGoogle=addressGoogle.replace(/, /,"\n");addressGoogle=addressGoogle.replace(/, USA$/,"");$("#map_canvas").show();Map("map_canvas",results[0].geometry.location);$("#comandaddress").val(addressToSave);$("#addressOK").text(Address.addressValidation.prototype._addressOK);}}else{$("#addressOK").text(Address.addressValidation.prototype._addressKO);}});};
/* Sudo Slider v. 2.2.6 */
...
var initParams=null;function InitParams(txtBegudaNoPromocio,txtNoMoreDrinksToAddinPromo,txtAddDrinkstoBox,txtdescompteaplicat,txtpromodeleted,txtfaltahora,txtcheckaddress,checkok,checkko,txtconfirm,txtproductes,txtproducte,txtnomesdomocili,txtbottreurepromo){this.txtBegudaNoPromocio=txtBegudaNoPromocio;this.txtNoMoreDrinksToAddinPromo=txtNoMoreDrinksToAddinPromo;this.txtAddDrinkstoBox=txtAddDrinkstoBox;this.txtdescompteaplicat=txtdescompteaplicat;this.txtpromodeleted=txtpromodeleted;this.txtfaltahora=txtfaltahora;this.txtcheckaddress=txtcheckaddress;this.checkok=checkok;this.checkko=checkko;this.txtconfirm=txtconfirm;this.txtproductes=txtproductes;this.txtproducte=txtproducte;this.txtnomesdomocili=txtnomesdomocili;this.txtbottreurepromo=txtbottreurepromo;}window.setTimeout(function(){var chargeBar=new Progress.bar({id:"progress1",autoRemove:false,backgroundSpeed:5,type:"charge"});chargeBar.renderTo(document.getElementById("chargeBar"));var percent=0;window.setInterval(function(){percent=percent+Math.floor(Math.random()*10);percent=percent>=100?0:percent;chargeBar.update(percent);},500);},500);$("#chargeBar").hide();$("#arecollir_div").hide();$("#adomicili_div").hide();function initNumPlats(){}function initNumBegudes(){var numbegudes=window.localStorage.getItem("comanda.numbegudes");if(numbegudes!="undefined"&&numbegudes!=null){$("#numbegudes").text(numbegudes);}}function initAddress(){if(window.addressToLoad!=""){var arrayAddress=window.addressToLoad.split("-");$("#carrer").val(arrayAddress[0]);$("#codi").val(arrayAddress[arrayAddress.length-1]);$("#comandaddress").val(window.addressToLoad);$("#checkAdd").click();}}function goToRestaurantMenu(id){var comanda=window.localStorage.getItem("comanda");var data=window.localStorage.getItem("comanda.data");var comandaConfirm=window.localStorage.getItem("comanda.confirm");if(comandaConfirm!="undefined"&&comandaConfirm!=null){var currentDay=new Date();if((currentDay.getTime()-comandaConfirm)>60*confirmTime){window.localStorage.removeItem("comanda.confirm");}}comandaConfirm=window.localStorage.getItem("comanda.confirm");var restaurantId=window.localStorage.getItem("comanda.restaurant");if(restaurantId!="undefined"&&restaurantId!=null&&restaurantId!=id){alertOnline.alertes(txtavisdosrestaurants);}if(comanda!="undefined"&&comanda!=null&&comandaConfirm==null){var day=new Date();window.localStorage.setItem("comanda.confirm",day.getTime());acceptComandaDialog();}else{window.location.href="/"+context+"/comanda/Welcome.action?restaurantId="+id+"&data="+data;}}var actionCloseConfirm=function(){var data=window.localStorage.getItem("comanda.data");var idRestaurant=window.localStorage.getItem("comanda.restaurant");if(idRestaurant=="undefined"||idRestaurant==null){return;}window.localStorage.clear();window.localStorage.setItem("comanda.data",data);window.localStorage.setItem("comanda.restaurant",idRestaurant);window.location.href="/"+context+"/comanda/Welcome.action?restaurantId="+idRestaurant+"&data="+data;};function acceptComandaDialog(){confirmComanda();}var confirmComanda=function(){var comanda=window.localStorage.getItem("comanda");var idRestaurant=window.localStorage.getItem("comanda.restaurant");if(idRestaurant=="undefined"||idRestaurant==null){return;}if($("#list_rest_"+idRestaurant).hasClass("tancat")){alertOnline.alertes(initParams.txtavisrestauranttancat);}if(comanda!="undefined"&&comanda!=null){var data=window.localStorage.getItem("comanda.data");window.location.href="/"+context+"/comanda/Welcome.action?restaurantId="+idRestaurant+"&idComanda="+comanda+"&data="+data;}};function reloadHores(){var dia=$("#dia").val();var data=window.localStorage.setItem("comanda.data",dia);var comanda=window.localStorage.getItem("comanda");var data="data="+dia+"&idComanda="+comanda;if($("#adomicili").is(":checked")){data=data+"&aDomicili=true";}else{data=data+"&aDomicili=false";}$.ajax({type:"POST",url:"/"+context+"/comanda/loadHores.action",dataType:"json",data:data,success:function(json){if(json!=null&&json.error!=null){errorOnline.error("Error in AJAX: "+json.error);}else{$("#comandahora").val("");if(json._0800=="true"){setHourCheck("0800");}else{setHourNotCheck("0800");}if(json._0830=="true"){setHourCheck("0830");}else{setHourNotCheck("0830");}if(json._0900=="true"){setHourCheck("0900");}else{setHourNotCheck("0900");}if(json._0930=="true"){setHourCheck("0930");}else{setHourNotCheck("0930");}if(json._1000=="true"){setHourCheck("1000");}else{setHourNotCheck("1000");}if(json._1030=="true"){setHourCheck("1030");}else{setHourNotCheck("1030");}if(json._1100=="true"){setHourCheck("1100");}else{setHourNotCheck("1100");}if(json._1130=="true"){setHourCheck("1130");}else{setHourNotCheck("1130");}if(json._1200=="true"){setHourCheck("1200");}else{setHourNotCheck("1200");}if(json._1230=="true"){setHourCheck("1230");}else{setHourNotCheck("1230");}if(json._1300=="true"){setHourCheck("1300");}else{setHourNotCheck("1300");}if(json._1330=="true"){setHourCheck("1330");}else{setHourNotCheck("1330");}if(json._1400=="true"){setHourCheck("1400");}else{setHourNotCheck("1400");}if(json._1430=="true"){setHourCheck("1430");}else{setHourNotCheck("1430");}if(json._1500=="true"){setHourCheck("1500");}else{setHourNotCheck("1500");}if(json._1530=="true"){setHourCheck("1530");}else{setHourNotCheck("1530");}if(json._1600=="true"){setHourCheck("1600");}else{setHourNotCheck("1600");}if(json._1630=="true"){setHourCheck("1630");}else{setHourNotCheck("1630");}if(json._1700=="true"){setHourCheck("1700");}else{setHourNotCheck("1700");}if(json._1730=="true"){setHourCheck("1730");}else{setHourNotCheck("1730");}if(json._1800=="true"){setHourCheck("1800");}else{setHourNotCheck("1800");}if(json._1830=="true"){setHourCheck("1830");}else{setHourNotCheck("1830");}if(json._1900=="true"){setHourCheck("1900");}else{setHourNotCheck("1900");}if(json._1930=="true"){setHourCheck("1930");}else{setHourNotCheck("1930");}if(json._2000=="true"){setHourCheck("2000");}else{setHourNotCheck("2000");}if(json._2030=="true"){setHourCheck("2030");}else{setHourNotCheck("2030");}if(json._2100=="true"){setHourCheck("2100");}else{setHourNotCheck("2100");}if(json._2130=="true"){setHourCheck("2130");}else{setHourNotCheck("2130");}if(json._2200=="true"){setHourCheck("2200");}else{setHourNotCheck("2200");}if(json._2230=="true"){setHourCheck("2230");}else{setHourNotCheck("2230");}if(json._2300=="true"){setHourCheck("2300");}else{setHourNotCheck("2300");}if(json._2330=="true"){setHourCheck("2330");}else{setHourNotCheck("2330");}if(json._2400=="true"){setHourCheck("2400");}else{setHourNotCheck("2400");}}},error:function(e){errorOnline.error(txterrorAjax);}});}function checKHour(id){if($("#"+id).hasClass("notcheck")){return;}var id_old=$("#comandahora").val();$("#"+id_old).removeClass("checked");$("#"+id_old).addClass("check");$("#"+id).removeClass("check");$("#"+id).addClass("checked");$("#comandahora").val(id);}function setHourNotCheck(id){$("#"+id).removeClass("check");$("#"+id).removeClass("checked");$("#"+id).addClass("notcheck");}function setHourCheck(id){$("#"+id).addClass("check");$("#"+id).removeClass("checked");$("#"+id).removeClass("notcheck");}function setHourChecked(id){$("#"+id).removeClass("check");$("#"+id).addClass("checked");$("#"+id).removeClass("notcheck");}function payComanda(){var comanda=window.localStorage.getItem("comanda");if(comanda!=null&&comanda!="undefined"){$("#chargeBar").show();var subdata=checkPromoImport();var data="idComanda="+comanda+subdata;window.location.href="/"+context+"/payment/paymentEntry.action?"+data;}}function checkPromoImport(){var promo=window.localStorage.getItem("comanda.promo.descompte");if(promo!=null&&promo!="undefined"){var importe=window.localStorage.getItem("comanda.promo.descompte.import");var tipus=window.localStorage.getItem("comanda.promo.descompte.tipus");return"&tipuDescomte="+tipus+"&importDescomte="+importe;}return"";}function onlyEntero(value,id){if(value==""||/^[0-9]*$/.test(value)){$("#"+id).css("border","solid 1px rgb(135,155,179)");return true;}else{$("#"+id).css("border","solid 1px red");alertOnline.alertes(initTableParams.txterrornumber);return false;}}function saveNewPLatAmount(id,value){var preuPlat=$("#platpreu_"+id).text();var preu=$("#preu").text();var numPlatsAnt=window.localStorage.getItem("comanda.plat_"+id);if(numPlatsAnt!="undefined"&&numPlatsAnt!=null){var nPlatsAdded=parseInt(value);$("#labelnum_"+id).text(parseInt(numPlatsAnt)+parseInt(value));window.localStorage.setItem("comanda.plat_"+id,parseInt(numPlatsAnt)+parseInt(value));var preuToAdd=parseFloat(preuPlat)*nPlatsAdded;var preuActual=$("#labelpreutotal_"+id).text();var newPreu=preuToAdd+parseFloat(preuActual);$("#labelpreutotal_"+id).text(parseFloat(newPreu).toFixed(2));var preuCom=parseFloat(preu)+preuToAdd;$("#preu").text(parseFloat(preuCom).toFixed(2));$("#labelpreutotalPromo").text(parseFloat(preuCom).toFixed(2));var preuPlats=window.localStorage.getItem("comanda.preu");window.localStorage.setItem("comanda.preu",parseFloat(parseFloat(preuPlats)+parseFloat(preuToAdd)).toFixed(2));initPromoDescompteFromStorage();savePlatToComanda(id,nPlatsAdded);var platsAnterior=window.localStorage.getItem("comanda.numplats");var platsAra=parseInt(platsAnterior)+parseInt(nPlatsAdded);window.localStorage.setItem("comanda.numplats",platsAra);if(platsAra<=0){alertOnline.alertes("No tens plats a la comanda");}var lis=window.localStorage.getItem("comanda.plats.lis");var lista="";var plats=lis.split("<br><br>");$.each(plats,function(index,value){if(value.indexOf("span_p_"+id)==-1){lista=lista+value+"<br><br>";}else{var liEnd=value.split("</span>");var li=platsAra+" <span class='plats' id='span_p_"+id+"'>x</span> "+liEnd[1]+"<br><br>";lista=lista+li;}});window.localStorage.setItem("comanda.plats.lis",lista);}}function eliminaPlat(id){window.localStorage.setItem("comanda.plat_"+id,"0");var n=$("#labelnum_"+id).text();$("#labelnum_"+id).text("0");var preuTotalPlat=$("#labelpreutotal_"+id).text();$("#labelpreutotal_"+id).text("0");var preu=$("#preu").text();var preuComanda=parseFloat(preu)-parseFloat(preuTotalPlat);$("#preu").text(parseFloat(preuComanda).toFixed(2));$("#labelpreutotalPromo").text(parseFloat(preuComanda).toFixed(2));initPromoDescompteFromStorage();savePlatToComanda(id,-n);var platsAnterior=window.localStorage.getItem("comanda.numplats");var platsAra=parseInt(platsAnterior)-parseInt(n);window.localStorage.setItem("comanda.numplats",platsAra);if(platsAra<=0){alertOnline.alertes("No tens plats a la comanda");}$("#plat_"+id).remove();var lis=window.localStorage.getItem("comanda.plats.lis");var lista="";var plats=lis.split("<br><br>");$.each(plats,function(index,value){if(value.indexOf("span_p_"+id)==-1){lista=lista+value+"<br><br>";}});window.localStorage.setItem("comanda.plats.lis",lista);}function eliminaBeguda(id){var n=$("#labelnum_b_"+id).text();$("#labelnum_b_"+id).text("0");var preuTotalBeguda=$("#labelpreutotal_b_"+id).text();$("#labelpreutotal_b_"+id).text("0");var preu=$("#preu").text();var preuComanda=parseFloat(preu)-parseFloat(preuTotalBeguda);$("#preu").text(parseFloat(preuComanda).toFixed(2));$("#labelpreutotalPromo").text(parseFloat(preuComanda).toFixed(2));saveBegudaToComanda(id,false,-n);var lis=window.localStorage.getItem("comanda.begudes.lis");var lista="";var begudes=lis.split("<br><br>");$.each(begudes,function(index,value){if(value.indexOf("span_b_"+id)==-1){lista=lista+value+"<br><br>";}});window.localStorage.setItem("comanda.begudes.lis",lista);}function addDomicili(){var preu=$("#preu").text();var preuT=$("#labelpreutotalPromo").text();$("#arecollir_div").hide("slow");if($("#adomicili").is(":checked")){$("#arecollir").attr("checked",false);$("#transport_lb").text(transportPreu);$("#preu").text(parseFloat(parseFloat(preu)+parseFloat(transportPreu)).toFixed(2));$("#labelpreutotalPromo").text(parseFloat(parseFloat(preuT)+parseFloat(transportPreu)).toFixed(2));initPromoDescompteFromStorage();$("#adomicili_div").show("slow");}else{$("#adomicili_div").hide("slow");$("#transport_lb").text("0");$("#preu").text(parseFloat(parseFloat(preu)-parseFloat(transportPreu)).toFixed(2));$("#labelpreutotalPromo").text(parseFloat(parseFloat(preuT)-parseFloat(transportPreu)).toFixed(2));initPromoDescompteFromStorage();}reloadHores();}function targeta(){$("#targetaContrarembols").val("targeta");$("#contrarembols").attr("checked",false);}function contrarembols(){$("#targetaContrarembols").val("contrarembols");$("#targeta").attr("checked",false);}function addRecollir(){if($("#arecollir").is(":checked")){var idcomanda=window.localStorage.getItem("comanda");var data="idComanda="+idcomanda;$.ajax({type:"POST",url:"/"+context+"/comanda/ajaxLoadInfoARecollir.action",dataType:"json",data:data,success:function(json){if(json!=null&&json.error!=null){errorOnline.error("Error in AJAX: "+json.error);}else{if(json.moreThanOne=="true"||json.moreThanOne==true){alertOnline.alertes(initParams.txtnomesdomocili);return;}if($("#adomicili").is(":checked")){$("#adomicili").attr("checked",false);$("#adomicili_div").hide("slow");var preu=$("#preu").text();var preuT=$("#labelpreutotalPromo").text();$("#transport_lb").text("0");$("#preu").text(parseFloat(parseFloat(preu)-parseFloat(transportPreu)).toFixed(2));$("#labelpreutotalPromo").text(parseFloat(parseFloat(preuT)-parseFloat(transportPreu)).toFixed(2));initPromoDescompteFromStorage();}$("#targetaContrarembols").val("targeta");$("#address_restaurant").text(json.address);$("#arecollir_div").show("slow");}},error:function(e){errorOnline.error(txterrorAjax);}});reloadHores();}else{$("#arecollir_div").hide("slow");}}function savePlatToComanda(idPlat,nPlats){var idcomanda=window.localStorage.getItem("comanda");var data="idPlat="+idPlat+"&idComanda="+idcomanda+"&nplats="+nPlats;$.ajax({type:"POST",url:"/"+context+"/comanda/ajaxLoadNumPlat.action",dataType:"json",data:data,success:function(json){if(json!=null&&json.error!=null){errorOnline.error("Error in AJAX: "+json.error);}else{}},error:function(e){errorOnline.error(txterrorAjax);}});}function checkComandaJS(){var comanda=window.localStorage.getItem("comanda");var plats=window.localStorage.getItem("comanda.numplats");if(plats<=0){alertOnline.alertes("No tens plats a la comanda");return;}if(comanda!=null&&comanda!="undefined"){var hora=$("#comandahora").val();var dia=$("#dia").val();if(hora==""){alertOnline.alertes(initParams.txtfaltahora);return;}var adomicili=false;var address=$("#comandaddress").val();if($("#adomicili").is(":checked")){adomicili=true;if(address==""){alertOnline.alertes(initParams.txtcheckaddress);return;}address=address.replace(/\n/g,"");}var targeta=false;var targetaContrarembols=$("#targetaContrarembols").val();if(targetaContrarembols=="contrarembols"){}else{if(targetaContrarembols=="targeta"){targeta=true;}else{targeta=true;}}var promoId=window.localStorage.getItem("comanda.promo.id");var tipusPromo=window.localStorage.getItem("comanda.promo.tipus");$("#chargeBar").show();var data="idComanda="+comanda+"&dia="+dia+"&hora="+hora+"&aDomicili="+adomicili+"&targeta="+targeta+"&address="+address+"&promoId="+promoId+"&tipusPromo="+tipusPromo;$.ajax({type:"POST",url:"/"+context+"/comanda/checkComanda.action",dataType:"json",data:data,success:function(json){if(json==null||json.error!=null){$("#errorsajaxlabel").text(json.error);$("#errorsajax").show();}else{if(json.alertLoged!=null){alertOnline.alertes(json.alertLoged);$("#chargeBar").hide();return;}if(json.alerta!=null){alertOnline.alertes(json.alerta);$("#chargeBar").hide();return;}if(json.comandaOK!=null){alertOnline.alertes(json.comandaOK);$("#chargeBar").hide();$("#checkPromocionsDisponibles").show();payComanda();return;}}$("#chargeBar").hide();},error:function(e){errorOnline.error(txterrorAjax);}});}}var func=$(function(){$(".draggable").click(function(){var dragBeguda=$(this).clone();dragBeguda.appendTo("#preus");dragBeguda.animate({width:"90%",opacity:0.4,marginLeft:"0.6in",fontSize:"3em",borderWidth:"10px",left:"+=250px"},1800,function(){var id=$(this).attr("id");var tipus=$(this).attr("title");addingBegudaMangaer(id,tipus);$(this).css("visiblity","hidden");$(this).css("display","none");});});function addingBegudaMangaer(id,tipus){if(window.promoBeguda==null||window.promoBeguda.promo!="true"){saveBegudaToComanda(id,false,1);}else{if(window.promoBeguda.numBegudesAdded<window.promoBeguda.numBegudes){if(tipus!=window.promoBeguda.tipusBeguda){alertOnline.alertes(initParams.txtBegudaNoPromocio);return;}var n=window.promoBeguda.numBegudesAdded;window.promoBeguda.numBegudesAdded=parseInt(n)+1;saveBegudaToComanda(id,true,1);}else{saveBegudaToComanda(id,false,1);}}}});function saveBegudaToComanda(idBeguda,promo,amount){var data="idBeguda="+idBeguda+"&idComanda="+$("#idcomanda").val()+"&amount="+amount+"&promo="+promo;$.ajax({type:"POST",url:"/"+context+"/comanda/ajaxLoadBeguda.action",dataType:"json",data:data,success:function(json){if(json!=null&&json.error!=null){errorOnline.error("Error in AJAX: "+json.error);}else{if(json.alerta!=null){alertOnline.alertes(json.alerta);}else{var numBegudes=0;var numBegudesPromo=0;var preuBegudes=0;var html="";var begudes=json.begudes;$("#beguda_p_"+idBeguda).remove();$("#beguda_"+idBeguda).remove();var table=document.getElementById("order");var lis="";$.each(begudes,function(index,value){numBegudesPromo=numBegudesPromo+value.numBegudesPromo;numBegudes=numBegudes+value.numBegudes;preuBegudes=parseFloat(preuBegudes)+parseFloat(value.beguda.preu)*value.numBegudes;if(value.beguda.id==idBeguda){if(value.numBegudes!=0){var row=table.insertRow(1);$(row).addClass("selector_pl");row.id="beguda_"+value.beguda.id;var cell1=row.insertCell(0);var cell2=row.insertCell(1);var cell3=row.insertCell(2);var cell4=row.insertCell(3);var cell5=row.insertCell(4);var cell6=row.insertCell(5);$(cell1).addClass("img_order");cell1.innerHTML="<img width='114px' src='"+context+"/comanda/ImageAction.action?imageId="+value.beguda.foto.id+"' />";$(cell2).addClass("descri");cell2.innerHTML="<span class='tit'>"+value.beguda.nom+"</span><br>"+value.beguda.descripcio+"</td>";$(cell3).addClass("preusun");cell3.innerHTML="<label id='begudapreu_"+value.beguda.id+"' >"+value.beguda.preu+"</label>&euro;";$(cell4).addClass("canti");cell4.innerHTML="<input class='mores' type='submit' onclick='saveBegudaToComanda("+value.beguda.id+",false,-1);' value='-'><label id='labelnum_b_"+value.beguda.id+"'>"+value.numBegudes+"</label><input class='mores' type='submit' onclick='saveBegudaToComanda("+value.beguda.id+",false,1);' value='+'>";$(cell5).addClass("total");cell5.innerHTML="<label id='labelpreutotal_b_"+value.beguda.id+"'>"+parseFloat(parseFloat(value.beguda.preu)*parseFloat(value.numBegudes)).toFixed(2)+"</label> &euro;";$(cell6).addClass("elimi");cell6.innerHTML="<input class='elimin' type='submit' onclick='eliminaBeguda("+value.beguda.id+")'  value='ELIMINAR'>";var li=value.numBegudes+" <span class='plats' id='span_b_"+value.beguda.id+"'>x</span> "+value.beguda.nom+"<br><br>";lis=lis+li;}if(value.numBegudesPromo!=0){var row=table.insertRow(1);$(row).addClass("selector_pl");row.id="beguda_p_"+value.beguda.id;var list=window.localStorage.getItem("comanda.promo.begudes.list");if(list=="undefined"||list==null){window.localStorage.setItem("comanda.promo.begudes.list",value.beguda.id);}else{window.localStorage.setItem("comanda.promo.begudes.list",list+","+value.beguda.id);}var cell1=row.insertCell(0);var cell2=row.insertCell(1);var cell3=row.insertCell(2);var cell4=row.insertCell(3);var cell5=row.insertCell(4);var cell6=row.insertCell(5);$(cell1).addClass("img_order");cell1.innerHTML="<img width='114px' src='"+context+"/comanda/ImageAction.action?imageId="+value.beguda.foto.id+"' />";$(cell2).addClass("descri");cell2.innerHTML="<span class='tit'>"+value.beguda.nom+"</span><br>"+value.beguda.descripcio+"</td>";$(cell3).addClass("preusun");cell3.innerHTML="<label id='begudapreu_p_"+value.beguda.id+"' >"+value.beguda.preu+"</label>&euro;";$(cell4).addClass("canti");cell4.innerHTML="<label id='labelnum_b_p_"+value.beguda.id+"'>"+value.numBegudesPromo+"</label>";$(cell5).addClass("total");cell5.innerHTML="<label id='labelpreutotal_b_p_"+value.beguda.id+"'>0</label> &euro;";$(cell6).addClass("elimi");cell6.innerHTML="<input class='elimin' type='submit' onclick='deletePromoApplied();'  value='"+initParams.txtbottreurepromo+"'>";var li=value.numBegudesPromo+" <span class='plats' id='span_b_"+value.beguda.id+"'>x</span> "+value.beguda.nom+"(PROMO)<br><br>";lis=lis+li;}}});window.localStorage.setItem("comanda.begudes.lis",lis);window.localStorage.setItem("comanda.promo.nBegudes.added",numBegudesPromo);window.localStorage.setItem("comanda.numbegudes",numBegudes);window.localStorage.setItem("comanda.beguda.preu",preuBegudes.toFixed(2));var preuComanda=window.localStorage.getItem("comanda.preu");var transport=0;if($("#adomicili").is(":checked")){transport=40;}var preuFinal=parseFloat(preuComanda)+parseFloat(preuBegudes)+parseFloat(transport);$("#preu").text(preuFinal.toFixed(2));$("#labelpreutotalPromo").text(preuFinal.toFixed(2));initPromoDescompteFromStorage();}}},error:function(e){errorOnline.error(txterrorAjax);}});}Calendar.setup({inputField:"dia",ifFormat:"%Y-%m-%d",button:"llencadorData1",locale:"ca_ES"});new Address.addressValidation();$("#checkPromocionsDisponibles").hide();$("#deletePromoApplied").hide();var sudoSlider=$("#slider").sudoSlider({autowidth:false,slideCount:3,continuous:true});function checkPromocionsDisponibles(){var comandaId=window.localStorage.getItem("comanda");if(comandaId!=null&&comandaId!="undefined"){var data="idComanda="+comandaId;$("#chargeBar").show();$.ajax({type:"POST",url:"/"+context+"/comanda/checkComandaPromos.action",dataType:"json",data:data,success:function(json){if(json!=null&&json.error!=null){errorOnline.error("Error in AJAX: "+json.error);}else{if(json.alertLoged!=null){alertOnline.alertes(json.alertLoged);$("#chargeBar").hide();return;}$("#dialog_promo ul#prm").html("");if(json.promosNumComanda!=null){fillPromos(json.promosNumComanda[0]);}if(json.promosAPartirDe!=null){fillPromos(json.promosAPartirDe[0]);}}$("#chargeBar").hide();},error:function(e){errorOnline.error(txterrorAjax);}});}}function checkPromoEspecial(){var data="";$.ajax({type:"POST",url:"/"+context+"/comanda/checkPromosEspecial.action",dataType:"json",data:data,success:function(json){if(json!=null&&json.error!=null){errorOnline.error("Error in AJAX: "+json.error);}else{$("#dialog_promo ul#esp").html("");if(json!=null){fillPromosEsp(json);}}},error:function(e){errorOnline.error(txterrorAjax);}});}function fillPromosEsp(json){$.each(json,function(index,item){if(item.numBegudes!=null&&item.numBegudes!="undefined"&&json.numBegudes!="0"){var liToAppend="<li><a href='#' onclick=\"addPromoBeguda('"+item.numBegudes+"','"+item.tipusBeguda+"','"+item.id+"','esp')\" >'Te un descompte per escollir "+item.numBegudes+" begudes de tipus "+item.tipusBeguda+"</a>";$("#dialog_promo ul#esp").append(liToAppend);}if(item.descompteImport!=null&&item.descompteImport!="undefined"&&item.descompteImport!="0"){var liToAppend="<li><a href='#' onclick=\"addPromoImport('"+item.descompteImport+"','"+item.tipuDescompte+"','"+item.id+"','esp')\" >'Te un descompte de  "+item.descompteImport+" en "+item.tipuDescompte+"</a>";$("#dialog_promo ul#esp").append(liToAppend);}});}function fillPromos(json){$.each(json,function(index,item){if(item.numBegudes!=null&&item.numBegudes!="undefined"&&json.numBegudes!="0"){var liToAppend="<li><a href='#' onclick=\"addPromoBeguda('"+item.numBegudes+"','"+item.tipusBeguda+"','"+item.id+"','gen')\" >'Te un descompte per escollir "+item.numBegudes+" begudes de tipus "+item.tipusBeguda+"</a>";$("#dialog_promo ul#prm").append(liToAppend);}if(item.descompteImport!=null&&item.descompteImport!="undefined"&&item.descompteImport!="0"){var liToAppend="<li><a href='#' onclick=\"addPromoImport('"+item.descompteImport+"','"+item.tipuDescompte+"','"+item.id+"','gen')\" >'Te un descompte de  "+item.descompteImport+" en "+item.tipuDescompte+"</a>";$("#dialog_promo ul#prm").append(liToAppend);}});}function checkBegudaToAddPromo(promo){var data="idComanda="+$("#idcomanda").val()+"&promo="+promo;$.ajax({type:"POST",url:"/"+context+"/comanda/checkBegudaToAddPromo.action",dataType:"json",data:data,success:function(json){if(json!=null&&json.error!=null){errorOnline.error("Error in AJAX: "+json.error);}else{if(json.alerta!=null){alertOnline.alertes(json.alerta);}else{var numBegudes=0;var numBegudesPromo=0;var preuBegudes=0;var html="";var begudes=json.begudes;var table=document.getElementById("order");var lis="";$.each(begudes,function(index,value){numBegudesPromo=numBegudesPromo+value.numBegudesPromo;numBegudes=numBegudes+value.numBegudes;preuBegudes=parseFloat(preuBegudes)+parseFloat(value.beguda.preu)*value.numBegudes;$("#beguda_p_"+value.beguda.id).remove();$("#beguda_"+value.beguda.id).remove();if(value.numBegudes!=0){var row=table.insertRow(1);$(row).addClass("selector_pl");row.id="beguda_"+value.beguda.id;var cell1=row.insertCell(0);var cell2=row.insertCell(1);var cell3=row.insertCell(2);var cell4=row.insertCell(3);var cell5=row.insertCell(4);var cell6=row.insertCell(5);$(cell1).addClass("img_order");cell1.innerHTML="<img width='114px' src='"+context+"/comanda/ImageAction.action?imageId="+value.beguda.foto.id+"' />";$(cell2).addClass("descri");cell2.innerHTML="<span class='tit'>"+value.beguda.nom+"</span><br>"+value.beguda.descripcio+"</td>";$(cell3).addClass("preusun");cell3.innerHTML="<label id='begudapreu_"+value.beguda.id+"' >"+value.beguda.preu+"</label>&euro;";$(cell4).addClass("canti");cell4.innerHTML="<input class='mores' type='submit' onclick='saveBegudaToComanda("+value.beguda.id+",false,-1);' value='-'><label id='labelnum_b_"+value.beguda.id+"'>"+value.numBegudes+"</label><input class='mores' type='submit' onclick='saveBegudaToComanda("+value.beguda.id+",false,1);' value='+'>";$(cell5).addClass("total");cell5.innerHTML="<label id='labelpreutotal_b_"+value.beguda.id+"'>"+parseFloat(parseFloat(value.beguda.preu)*parseFloat(value.numBegudes)).toFixed(2)+"</label> &euro;";$(cell6).addClass("elimi");cell6.innerHTML="<input class='elimin' type='submit' onclick='eliminaBeguda("+value.beguda.id+")'  value='ELIMINAR'>";var li=value.numBegudes+" <span class='plats' id='span_b_"+value.beguda.id+"'>x</span> "+value.beguda.nom+"<br><br>";lis=lis+li;}if(value.numBegudesPromo!=0){var row=table.insertRow(1);$(row).addClass("selector_pl");row.id="beguda_p_"+value.beguda.id;var list=window.localStorage.getItem("comanda.promo.begudes.list");if(list=="undefined"||list==null){window.localStorage.setItem("comanda.promo.begudes.list",value.beguda.id);}else{window.localStorage.setItem("comanda.promo.begudes.list",list+","+value.beguda.id);}var cell1=row.insertCell(0);var cell2=row.insertCell(1);var cell3=row.insertCell(2);var cell4=row.insertCell(3);var cell5=row.insertCell(4);var cell6=row.insertCell(5);$(cell1).addClass("img_order");cell1.innerHTML="<img width='114px' src='"+context+"/comanda/ImageAction.action?imageId="+value.beguda.foto.id+"' />";$(cell2).addClass("descri");cell2.innerHTML="<span class='tit'>"+value.beguda.nom+"</span><br>"+value.beguda.descripcio+"</td>";$(cell3).addClass("preusun");cell3.innerHTML="<label id='begudapreu_p_"+value.beguda.id+"' >"+value.beguda.preu+"</label>&euro;";$(cell4).addClass("canti");cell4.innerHTML="<label id='labelnum_b_p_"+value.beguda.id+"'>"+value.numBegudesPromo+"</label>";$(cell5).addClass("total");cell5.innerHTML="<label id='labelpreutotal_b_p_"+value.beguda.id+"'>0</label> &euro;";$(cell6).addClass("elimi");cell6.innerHTML="<input class='elimin' type='submit' onclick='deletePromoApplied();'  value='"+initParams.txtbottreurepromo+"'>";var li=value.numBegudesPromo+" <span class='plats' id='span_b_"+value.beguda.id+"'>x</span> "+value.beguda.nom+"(PROMO)<br><br>";lis=lis+li;}});window.localStorage.setItem("comanda.begudes.lis",lis);window.localStorage.setItem("comanda.promo.nBegudes.added",numBegudesPromo);window.localStorage.setItem("comanda.numbegudes",numBegudes);window.localStorage.setItem("comanda.beguda.preu",preuBegudes.toFixed(2));var preuComanda=window.localStorage.getItem("comanda.preu");var transport=0;if($("#adomicili").is(":checked")){transport=40;}var preuFinal=parseFloat(preuComanda)+parseFloat(preuBegudes)+parseFloat(transport);$("#preu").text(preuFinal.toFixed(2));$("#labelpreutotalPromo").text(preuFinal.toFixed(2));}}},error:function(e){errorOnline.error(txterrorAjax);}});}function addPromoBeguda(nbegudes,tipusBeguda,id,tipus){var numBegudes=window.localStorage.getItem("comanda.numbegudes");window.localStorage.setItem("comanda.promo.id",id);window.localStorage.setItem("comanda.promo.beguda","true");window.localStorage.setItem("comanda.promo.nBegudes.total",nbegudes);window.localStorage.setItem("comanda.promo.beguda.tipus",tipusBeguda);window.localStorage.setItem("comanda.promo.tipus",tipus);window.promoBeguda={promo:"true"};window.promoBeguda.numBegudesAdded=0;window.promoBeguda.numBegudes=parseInt(nbegudes);window.promoBeguda.tipusBeguda=tipusBeguda;$("#checkPromocionsDisponibles").hide();$("#deletePromoApplied").show();closeDialogPromos();if(numBegudes!="undefined"&&numBegudes!=null){checkBegudaToAddPromo(id);}alertOnline.alertes(initParams.txtAddDrinkstoBox);}function initPromoBegudaFromStorage(){var isPromo=window.localStorage.getItem("comanda.promo.beguda");if(isPromo=="undefined"||isPromo==null){window.promoBeguda=null;}else{var nbegudes=window.localStorage.getItem("comanda.promo.nBegudes.total");var tipoBeguda=window.localStorage.getItem("comanda.promo.beguda.tipus");var id=window.localStorage.getItem("comanda.promo.id");var tipus=window.localStorage.getItem("comanda.promo.tipus");if(nbegudes!="undefined"&&nbegudes!=null&&tipoBeguda!="undefined"&&tipoBeguda!=null&&id!="undefined"&&id!=null&&tipus!="undefined"&&tipus!=null){addPromoBeguda(nbegudes,tipoBeguda,id,tipus);var nbegudesAdded=window.localStorage.getItem("comanda.promo.nBegudes.added");window.promoBeguda.numBegudesAdded=nbegudesAdded;$("#numbegudespromo").text(nbegudesAdded);}}}function initPromoDescompteFromStorage(){var isPromo=window.localStorage.getItem("comanda.promo.descompte");if(isPromo=="undefined"||isPromo==null){window.promoDescompte=null;}else{var importe=window.localStorage.getItem("comanda.promo.descompte.import");var tipoDescompte=window.localStorage.getItem("comanda.promo.descompte.tipus");var id=window.localStorage.getItem("comanda.promo.id");var tipus=window.localStorage.getItem("comanda.promo.tipus");if(importe!="undefined"&&importe!=null&&tipoDescompte!="undefined"&&tipoDescompte!=null){addPromoImport(importe,tipoDescompte,id,tipus);}}}function addPromoImport(importDescompte,tipusDescompte,id,tipus){window.localStorage.setItem("comanda.promo.id",id);window.localStorage.setItem("comanda.promo.descompte","true");window.localStorage.setItem("comanda.promo.descompte.import",importDescompte);window.localStorage.setItem("comanda.promo.descompte.tipus",tipusDescompte);window.localStorage.setItem("comanda.promo.tipus",tipus);window.promoDescompte={promo:"true"};window.promoDescompte.importe=importDescompte;window.promoDescompte.tipus=tipusDescompte;var preuPlats=window.localStorage.getItem("comanda.preu");var preuBegudes=window.localStorage.getItem("comanda.beguda.preu");if(preuBegudes=="undefined"||preuBegudes==null){preuBegudes=0;window.localStorage.setItem("comanda.beguda.preu","0.0");}var transport=0;if($("#adomicili").is(":checked")){transport=40;}var preu=parseFloat(preuPlats)+parseFloat(preuBegudes)+parseFloat(transport);if(tipusDescompte=="1"||tipusDescompte=="tant per cent %"){var preuF=parseFloat(preu)*((100-parseFloat(importDescompte))/100);$("#promoImp").text("-"+importDescompte+" %");$("#labelpreutotalPromo").text(preu+" (-"+importDescompte+" %) ="+parseFloat(preuF).toFixed(2));}else{var preuF=parseFloat(preu)-parseFloat(importDescompte);$("#promoImp").text("-"+importDescompte+" Euros");$("#labelpreutotalPromo").text(preu+" (-"+importDescompte+" Euros) ="+parseFloat(preuF).toFixed(2));}$("#checkPromocionsDisponibles").hide();$("#deletePromoApplied").show();closeDialogPromos();}function deletePromoApplied(){var isPromoBeguda=window.localStorage.getItem("comanda.promo.beguda");var isPromoDescompte=window.localStorage.getItem("comanda.promo.descompte");window.localStorage.removeItem("comanda.promo.tipus");if(isPromoDescompte!="undefined"&&isPromoDescompte!=null){window.localStorage.removeItem("comanda.promo.descompte");window.localStorage.removeItem("comanda.promo.descompte.import");window.localStorage.removeItem("comanda.promo.descompte.tipus");window.localStorage.removeItem("comanda.promo.id");window.promoDescompte=null;var preuPlats=window.localStorage.getItem("comanda.preu");var preuBegudes=window.localStorage.getItem("comanda.beguda.preu");var transport=0;if($("#adomicili").is(":checked")){transport=40;}var preu=parseFloat(preuPlats)+parseFloat(preuBegudes)+parseFloat(transport);$("#promoImp").text("");$("#labelpreutotalPromo").text(preu.toFixed());}if(isPromoBeguda!="undefined"&&isPromoBeguda!=null){window.localStorage.removeItem("comanda.promo.beguda");window.localStorage.removeItem("comanda.promo.nBegudes.total");window.localStorage.removeItem("comanda.promo.beguda.tipus");window.localStorage.removeItem("comanda.promo.id");var list=window.localStorage.getItem("comanda.promo.begudes.list");if(list!="undefined"&&list!=null){var array=list.split(",");$.each(array,function(index,value){$("#beguda_p_"+value).remove();});}window.promoBeguda=null;$("#numbegudespromo").text("0");deleteAjaxBegudesPromo();}$("#deletePromoApplied").hide();$("#checkPromocionsDisponibles").show();}function deleteAjaxBegudesPromo(){var comandaId=window.localStorage.getItem("comanda");if(comandaId!=null&&comandaId!="undefined"){var data="idComanda="+comandaId;$.ajax({type:"POST",url:"/"+context+"/comanda/deleteBegudesPromo.action",dataType:"json",data:data,success:function(json){if(json!=null&&json.error!=null){errorOnline.error("Error in AJAX: "+json.error);}},error:function(e){errorOnline.error(txterrorAjax);}});}}function openDialogPromos(){$("#dialog_promo").dialog("open");}function closeDialogPromos(){$("#dialog_promo").dialog("close");}$("#dialog_promo").dialog({autoOpen:false,modal:true,position:"center",draggable:true,height:390,width:900,open:function(event,ui){checkPromocionsDisponibles();$("#dialog_promo").css("overflow","hidden");}});$(document).ready(function(){var comanda=window.localStorage.getItem("comanda");if(comanda!="undefined"&&comanda!=null){$("#numComanda").text(comanda);var preu=window.localStorage.getItem("comanda.preu");if(preu!="undefined"&&preu!=null){var preuBegudes=window.localStorage.getItem("comanda.beguda.preu");if(preuBegudes!="undefined"&&preuBegudes!=null){preu=parseFloat(preu)+parseFloat(preuBegudes);}$("#preu").text(parseFloat(preu).toFixed(2));$("#labelpreutotalPromo").text(parseFloat(preu).toFixed(2));}var numplats=window.localStorage.getItem("comanda.numplats");if(numplats=="undefined"||numplats==null){numplats=0;window.localStorage.setItem("comanda.numplats","0");}var numbegudes=window.localStorage.getItem("comanda.numbegudes");if(numbegudes=="undefined"||numbegudes==null){numbegudes=0;window.localStorage.setItem("comanda.numbegudes","0");}var nProductes=parseInt(numplats)+parseInt(numbegudes);if(nProductes==1){$("#numProduct").text(initParams.txtconfirm+" "+nProductes+" "+initParams.txtproducte);}else{if(nProductes>1){$("#numProduct").text(initParams.txtconfirm+" "+nProductes+" "+initParams.txtproductes);}}if(isNaN(nProductes)){window.localStorage.clear();$("#numProduct").text(initParams.txtconfirm+" 0 "+initParams.txtproductes);}}else{$("#numProduct").text(initParams.txtconfirm+" 0 "+initParams.txtproductes);}initPromoBegudaFromStorage();initPromoDescompteFromStorage();});