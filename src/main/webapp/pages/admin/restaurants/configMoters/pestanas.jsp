...
<%@ taglib prefix="s" uri="/struts-tags"%>
      ...
      <li id="pestanya.mto"  ><a href="#"><s:text name="txt.pestana.config" /></a></li>
      <li id="pestanya.mto" class="seleccionat" ><a href="<c:url value='configMoters.action' />"><s:text name="txt.pestana.moters" /></a></li>    
